class BedroomsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @bedroom.save
        format.html { redirect_to bedroom_url(@bedroom), notice: "Bedroom was successfully created." }
  ...
  def update
    respond_to do |format|
      if @bedroom.update(bedroom_params)
        format.html { redirect_to bedroom_url(@bedroom), notice: "Bedroom was successfully updated." }
  ...
  private
    ...
    def bedroom_params
      params.require(:bedroom).permit(:bedroom)
    end
end
