...
class PropertyTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create property_type" do
    assert_difference("PropertyType.count") do
      post property_types_url, params: { property_type: { property_type: @property_type.property_type } }
    end
  ...
  test "should update property_type" do
    patch property_type_url(@property_type), params: { property_type: { property_type: @property_type.property_type } }
